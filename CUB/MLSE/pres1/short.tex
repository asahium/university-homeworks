\documentclass[t,aspectratio=43,9pt]{beamer}
\usepackage{iftex}
\ifPDFTeX
...
\newcommand{\refline}[1]{%
  ...
  \hrule
  \vspace{0.3ex}
  \begin{minipage}[t][4.8mm][t]{\linewidth}
    \tiny\noindent\textbf{Refs:} #1
  \end{minipage}
  \vspace*{0.8mm}
}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://arxiv.org/abs/1909.09436}{Husain et al. (2019)}; \reflink{https://arxiv.org/abs/2101.00027}{Gao et al. (2020)}; \reflink{https://aclanthology.org/2020.findings-emnlp.139/}{Feng et al. (2020)}; \reflink{https://proceedings.neurips.cc/paper/2020/hash/1457c0d6bfcb4967418bfb8ac142f64a-Abstract.html}{Brown et al. (2020)}; \reflink{https://www.eleuther.ai/projects/gpt-j/}{Wang et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/1410.4615}{Zaremba et al. (2014)}; \reflink{https://dl.acm.org/doi/10.1109/ICSE.2012.6227135}{Hindle et al. (2012)}; \reflink{https://proceedings.neurips.cc/paper/2019/hash/7298332f04ac004a0ca44cc69ecf6f6b-Abstract.html}{Kulal et al. (2019)}; \reflink{https://proceedings.neurips.cc/paper/2021/hash/c24cd76e1ce41366a4bbe8a49b02a028-Abstract.html}{Hendrycks et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://www.eleuther.ai/projects/gpt-j/}{Wang et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://aclanthology.org/P02-1040/}{Papineni et al. (2002)}; \reflink{https://arxiv.org/abs/2009.10297}{Ren et al. (2020)}; \reflink{https://proceedings.neurips.cc/paper/2020/hash/ed23fbf18c2cd35f8c7f8de44f85c08d-Abstract.html}{Roziere et al. (2020)}; \reflink{https://proceedings.neurips.cc/paper/2019/hash/7298332f04ac004a0ca44cc69ecf6f6b-Abstract.html}{Kulal et al. (2019)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://proceedings.neurips.cc/paper/2021/hash/c24cd76e1ce41366a4bbe8a49b02a028-Abstract.html}{Hendrycks et al. (2021)}; \reflink{https://github.com/openai/human-eval}{OpenAI HumanEval repository}; \reflink{https://gvisor.dev/}{gVisor}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://arxiv.org/abs/1412.6980}{Kingma and Ba (2015)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://www.travis-ci.com/}{Travis CI}; \reflink{https://tox.wiki/}{Tox}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://github.com/EleutherAI/gpt-neo}{Black et al. (2021)}; \reflink{https://www.eleuther.ai/projects/gpt-j/}{Wang et al. (2021)}; \reflink{https://arxiv.org/abs/2101.00027}{Gao et al. (2020)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://proceedings.neurips.cc/paper/2021/hash/c24cd76e1ce41366a4bbe8a49b02a028-Abstract.html}{Hendrycks et al. (2021)}; \reflink{https://github.com/EleutherAI/gpt-neo}{Black et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://arxiv.org/abs/1904.02069}{Leveson (2019)}.}
\end{frame}
...
\begin{frame}[plain]
\centering
{\fontsize{26}{28}\selectfont\bfseries Backup / Q\&A\par}
\vfill
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://arxiv.org/abs/1904.09751}{Holtzman et al. (2019)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2001.08361}{Kaplan et al. (2020)}; \reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}.}
\end{frame}
...
\refline{\reflink{https://arxiv.org/abs/2107.03374}{Chen et al. (2021)}; \reflink{https://en.wikipedia.org/wiki/Primality_test}{standard primality-test observation.}}
\end{frame}
